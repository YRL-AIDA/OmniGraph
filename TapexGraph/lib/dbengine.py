...
class DBEngine:
    ...
    def execute(self, table_id, select_index, aggregation_index, conditions, lower=True):
        ...
        return query,table_id,{key:f"'{where_map[key]}'" if isinstance(where_map[key],str) else where_map[key] 
                               for key in where_map},schema,[o.result for o in out]
    def execute_str(self,sql):
        return self.conn.query(sql,None)